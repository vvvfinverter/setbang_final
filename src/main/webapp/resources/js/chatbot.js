...
const reply = [
  ['SETbang은 1인기업&스타트업 기업을 위한 공유오피스입니다.'],
  ['안녕하세요! SETbang입니다. 반갑습니다.'],
  ['SETbang에서는   1. 공유공간을 이용할 수 있어요. 2. 세무기장, 법인신청, 특허신청 서비스를 이용할 수 있어요. 3. 다양한 협력업체를 고객님과 연결해드려요.'],
...
addMessage('SETbang', '안녕하세요! SETbang입니다. 무엇을 도와드릴까요?');
