      ...
      <div class="Branch">
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="Branch__visual__slide">
                  <img src="./resources/image/slide2-1_pangyo2.jpg" alt="판교지점 이미지1">
              ...
              <div class="swiper-slide">
                <div class="Branch__visual__slide">
                  <img src="./resources/image/slide1-2_pangyo.jpg" alt="판교지점 이미지2">
                  <span class="Branch__visual__label">
                    공용 오피스
                  </span>
                </div>
              ...
              <div class="swiper-slide">
                <div class="Branch__visual__slide">
                  <img src="./resources/image/slide1-3_pangyo.jpg" alt="판교지점 이미지3">
                  <span class="Branch__visual__label">
                    휴게 공간
                  </span>
                </div>
            ...
            <div class="Branch__slide__swipe" id="officeSwiper">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="Branch__slide">
                    <div class="Branch__slide__photo">
                      <img src="./resources/image/slide2-1_pangyo.jpg" alt="사무 공간 이미지1">
                    </div>
                ...
                <div class="swiper-slide">
                  <div class="Branch__slide">
                    <div class="Branch__slide__photo">
                      <img src="./resources/image/slide2-3_pangyo.jpg" alt="사무 공간 이미지2">
                    </div>
                    <div class="Branch__slide__information">
                      <strong>사무기기실</strong>
                ...
                <div class="swiper-slide">
                  <div class="Branch__slide">
                    <div class="Branch__slide__photo">
                      <img src="./resources/image/slide2-4_pangyo.jpg" alt="사무 공간 이미지3">
                    </div>
                    <div class="Branch__slide__information">
                      <strong>탭룸</strong>
                      <p>맥주와 커피를 무한으로 제공</p>
        ...
        <div class="Branch__detail">
          <ul class="Branch__detail__list">
            <li class="Branch__detail__item">
              <strong>IT분야에 특화된 서비스를 제공</strong>
              <p>IT분야 종사하는 입주 멤버들을 지원하기 위한<br/>다양한 서비스를 제공합니다.<br/>IT분야 입주멤버가 집중할 수 있도록 특화된 공간.</p>
            </li>
            <li class="Branch__detail__item">
              <strong>보다 풍성해진 휴게공간</strong>
              <p>사업으로 인한 스트레스 해소시켜드리기 위해<br/>탭룸, 힐링룸, 멀티미디어룸을 도입하여<br/>입주 멤버를 지원하고 있습니다.</p>
            </li>
            <li class="Branch__detail__item">
        ...
        <div class="Branch__location">
          ...
          <div class="Branch__address">
            <p><strong>주소</strong>경기도 성남시 분당구 판교동 33, 10층</p>
