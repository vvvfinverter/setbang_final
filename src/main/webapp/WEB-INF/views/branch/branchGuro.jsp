            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="Branch__visual__slide">
                  <img src="./resources/image/slide1-1_guro.jpg" alt="구로지점  이미지1-1">
              ...
              <div class="swiper-slide">
                <div class="Branch__visual__slide">
                  <img src="./resources/image/slide1-2_guro.jpg" alt="구로지점 이미지1-2">
                  <span class="Branch__visual__label">
                    공용 오피스
                  </span>
                </div>
              ...
              <div class="swiper-slide">
                <div class="Branch__visual__slide">
                  <img src="./resources/image/slide1-3_guro.jpg" alt="구로지점 이미지1-3">
                  <span class="Branch__visual__label">
                    휴게 공간
                  </span>
                </div>
            ...
            <div class="Branch__slide__swipe" id="officeSwiper">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="Branch__slide">
                    <div class="Branch__slide__photo">
                      <img src="./resources/image/slide2-1_guro.jpg" alt="사무 공간 이미지1">
                    </div>
                ...
                <div class="swiper-slide">
                  <div class="Branch__slide">
                    <div class="Branch__slide__photo">
                      <img src="./resources/image/slide2-2_guro.jpg" alt="사무 공간 이미지2">
                    </div>
                    <div class="Branch__slide__information">
                      <strong>회의실</strong>
                ...
                <div class="swiper-slide">
                  <div class="Branch__slide">
                    <div class="Branch__slide__photo">
                      <img src="./resources/image/slide2-3_guro.jpg" alt="사무 공간 이미지3">
                    </div>
                    <div class="Branch__slide__information">
                      <strong>사무기기실</strong>
